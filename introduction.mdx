...
description: A complete REST API for building modern e-commerce applications with authentication, product management, shopping cart, and order processing
---

## Welcome to the E-Commerce API

The E-Commerce API is a full-featured REST API built with Node.js and Express that provides all the essential endpoints for building modern e-commerce applications. Whether you're creating a mobile app, web storefront, or integrating with existing systems, this API gives you the tools to manage products, users, orders, and more.
...
**Cart & orders** - Manage shopping carts and place orders. Requires authentication.
